...
const clients: Client[] = [
  ...
  { id: 'united-methodist-church', name: 'United Methodist Church', logo: "/logos/united_church_bg.png" },
  { id: 'church-of-north-india', name: 'Church of North India', logo: "/logos/church_of_NI_bg.png" },
];
